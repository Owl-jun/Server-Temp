...
- TASK LIST
    ...
    - [X] [REDIS 연동 및 성능체크](#5회차-redis-연동) [250524]

    <br>
- ISSUE LIST

    - [X] 250518 터미널 한글 깨짐 현상으로인해 디버깅 불편
        - 한글 인코딩 문제, 기존 개발 도중 spdlog 도입으로 인해 파일 별 저장된 인코딩이 달라진 상황이라 일단은 영어를 사용함으로 해결.
...
#### 5회차, REDIS 연동
- docker 에 Redis 서버 올리기
- hiredis 활용 c++ REDIS 연결
    <img src="./img/Redis01.png">
    최초 접근 -> 4056us , 캐시 등록 후 -> 1609,2390 .. **처리속도가 약 2배** 빨라지는 모습

#### 회고록

- `250519 일기` TOPIC : [모니터패턴 + 스레드풀 구조와 IOCP 비동기 콜백 구조는 아무리 생각해도 서로 닮아있다.](https://velog.io/@owljun/%EB%82%B4%EB%A8%B8%EB%A6%AC%EC%86%8D%EC%9D%B4%EC%95%BC%EA%B8%B0-OS01.-%EB%AA%A8%EB%8B%88%ED%84%B0%ED%8C%A8%ED%84%B4-%EC%8A%A4%EB%A0%88%EB%93%9C%ED%92%80-%EA%B5%AC%EC%A1%B0IOCP-%EB%B9%84%EB%8F%99%EA%B8%B0-%EC%BD%9C%EB%B0%B1-%EA%B5%AC%EC%A1%B0%EB%8A%94-%EC%95%84%EB%AC%B4%EB%A6%AC-%EC%83%9D%EA%B0%81%ED%95%B4%EB%8F%84-%EC%84%9C%EB%A1%9C-%EB%8B%AE%EC%95%84%EC%9E%88%EB%8B%A4)
